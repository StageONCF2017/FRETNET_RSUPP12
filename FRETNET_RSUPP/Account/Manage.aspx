<%@ Page Title="Gérer le compte" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Manage.aspx.vb" Inherits="FRETNET_RSUPP.Manage" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="Supprimer" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "Supprimer cette " & Item(Of OpenAuthAccountData)().ProviderDisplayName & " connexion de votre compte" %>'
